        ...
        <div class="delinternet-man-navbar">
            <div class="elementor-element e-con-boxed e-con">
                <div class="e-con-inner main-del-navbar">
                    <div class="main-del-menu-ul-container-xs-container">
                        <div class="inner-container">
                            <div style="margin-bottom: 1rem; display: flex; align-items: center; justify-content: space-between;">
                                <a href="/" class="logo-anchor">
                                    <img class="logo-img" src="<?php echo $logo["url"]; ?>" alt="<?php echo $logo["alt"]; ?>">
                                </a>
                                <button class="shall-we-call-you-icon-button-xs">
                    ...
                    <div class="right-side">
                        <button style="display: none;" class="responsive-menu-icon-button">
                        ...
                        <button class="shall-we-call-you-text-button">
